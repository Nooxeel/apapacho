/**
 * Sentry — Node.js runtime (Next.js server-side, App Router).
 *
 * Aplica las mismas reglas de PII que sentry.client.config.ts pero sin
 * Session Replay (no aplica a server-side).
 */
